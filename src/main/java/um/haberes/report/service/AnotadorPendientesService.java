...
public class AnotadorPendientesService {
    ...
    public AnotadorPendientesService(Environment environment, AnotadorClient anotadorClient) {
    ...
    private void generateReport(String filename, Integer facultadId, Integer anho, Integer mes) {
        ...
        try {
            ...
            for (AnotadorDto anotador : anotadorClient.findPendientesByFacultad(facultadId, anho, mes)) {
