...
public class ComparacionCodigosService {
    ...
    public String generate(Integer anho, Integer mes) {
        ...
        String filename = path + "comparacion.codigos." + "." + anho + "." + mes + ".pdf";
    ...
    private void generateReport(String filename, Integer anho, Integer mes) {
        ...
        try {
            ...
            ComparacionCodigosService.HeaderFooter event = new ComparacionCodigosService.HeaderFooter(anho, mes);
    ...
    private void addTableHeader(PdfPTable table) {
        ...
        PdfPCell cell = new PdfPCell(new Phrase("Cód", headerFont));
    ...
    private void addCodigoDetails(Document document, CodigoDto codigo, PdfPTable detailTable, BigDecimal totalNovedad, BigDecimal totalItem) throws DocumentException {
        ...
        String formattedTotalNovedad = totalNovedad.compareTo(BigDecimal.ZERO) != 0 ? numberFormat.format(totalNovedad) : "";
        String formattedTotalItem = numberFormat.format(totalItem);
        String formattedDiferencia = totalNovedad.compareTo(BigDecimal.ZERO) != 0 ? numberFormat.format(totalItem.subtract(totalNovedad).abs()) : "";
    ...
    static class HeaderFooter extends PdfPageEventHelper {
        ...
        public void setHeader(Document document) throws DocumentException, IOException {
            ...
            // Nueva fila para el titulo
            PdfPTable titleTable = new PdfPTable(1); // Solo una columna para centrar
            titleTable.setWidthPercentage(100);

            Paragraph titleParagraph = new Paragraph("Comparación de Códigos", new Font(Font.HELVETICA, 13, Font.BOLD));
